        ...
        <div class="min-h-screen bg-gradient-to-b from-green-50/50 via-white to-gray-50 py-12">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="text-gray-500 text-base">Your appointment has been successfully scheduled</p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="p-4 bg-gray-50 rounded-xl">
                                <div class="flex items-center gap-2 mb-1.5">
                                    ...
                                    <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Time</span>
                                </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Provider</div>
                ...
                <div v-if="booking.customer_notes" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <h3 class="font-semibold text-gray-900 text-sm">Your Notes</h3>
                    </div>
