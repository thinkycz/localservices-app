        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="grid grid-cols-5 gap-4">
                ...
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                    ...
                    <div class="text-xs text-gray-500 mb-0.5">Total Spent</div>
                ...
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                    ...
                    <div class="text-xs text-gray-500 mb-2">Services</div>
                    <div class="flex flex-wrap gap-1">
                        ...
                        <span v-if="customer.services_used.length === 0" class="text-xs text-gray-400">None</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                    <h2 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Booking History</h2>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr v-if="customer.bookings.length === 0">
                            <td colspan="6" class="px-6 py-16 text-center">
                                ...
                                <h3 class="text-base font-semibold text-gray-900 mb-1">No bookings yet</h3>
