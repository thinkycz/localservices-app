      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div class="bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 px-6 py-8">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p class="text-blue-200 mt-1 text-sm">Step 1 of 3: Let's start with the basics</p>
              </div>
          ...
          <form @submit.prevent="submit" class="p-6 md:p-8">
            <div class="space-y-6">
              <div>
                <label for="business_name" class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Business Name</label>
                <input
                  id="business_name"
              ...
              <div>
                <label for="business_phone" class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Business Phone</label>
                <input
                  id="business_phone"
              ...
              <div>
                <label for="business_email" class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Business Email</label>
                <input
                  id="business_email"
