          ...
          <div class="bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 px-6 py-8">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div class="flex items-center space-x-2 shrink-0">
                <Link :href="route('vendor.onboarding.step2')" class="w-3 h-3 rounded-full bg-white/40 hover:bg-white/60 transition-colors" :title="$t('Back to Step 2')"></Link>
          ...
          <form @submit.prevent="submit" class="p-6 md:p-8">
            <div class="mb-8">
              ...
              <div class="space-y-6">
                <div v-for="(offering, index) in form.offerings" :key="index" class="bg-white border border-gray-200 rounded-2xl p-6 relative shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h4 class="font-bold text-gray-900 mb-5 flex items-center gap-2">
                    <span class="w-6 h-6 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-xs">#{{ index + 1 }}</span>{{ $t('Offering Details') }}</h4>
              ...
              >
                ...
                </svg>{{ $t('Add Another Offering') }}</button>
            </div>
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-100">
              ...
              >{{ $t('Complete Setup') }}<svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
