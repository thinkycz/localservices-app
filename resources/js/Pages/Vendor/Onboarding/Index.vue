      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 pb-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center hover:shadow-md transition-shadow">
            ...
            <p class="text-sm text-gray-500 leading-relaxed">{{ $t('List your services on our platform and get discovered by clients in your area actively looking to book.') }}</p>
          </div>
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h4 class="text-sm font-bold text-gray-900">{{ $t('Service Profile') }}</h4>
