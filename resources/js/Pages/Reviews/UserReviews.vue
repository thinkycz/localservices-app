        ...
        <div class="bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-white">My Reviews</h1>
                        <p class="text-sm text-blue-200 mt-1">Reviews you've written for services</p>
                    </div>
                    <Link
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div v-else class="bg-white rounded-2xl shadow-sm border border-gray-100 p-16 text-center">
                ...
                <p class="text-gray-500 mb-6 max-w-sm mx-auto text-sm">
                    After completing a service, you can share your experience to help others.
                </p>
                <Link
                    :href="route('bookings.index')"
