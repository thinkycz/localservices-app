...
<template>
    ...
    <VendorLayout activePage="settings">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Settings</h1>
            <p class="text-sm text-gray-400 mt-1">Manage your account preferences and security</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            <div class="flex items-center gap-5">
                <!-- Avatar -->
                <div class="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl flex-shrink-0">
                    {{ userInitials }}
                </div>
                <!-- Info -->
                ...
                <!-- Role Badge -->
                <span class="px-3 py-1 bg-blue-50 text-blue-600 text-xs font-bold rounded-full flex-shrink-0">
                    Owner
                </span>
            </div>
        </div>
